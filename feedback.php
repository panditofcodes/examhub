...
<div class="col-lg-6">
<span class="logo"><a href="index.php"><img src="image/logo.png" height="40px" width="40px"></a> ExamHub </span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:panditofcodes@gmail.com" style="color:#000000">panditofcodes@gmail.com</a><br /><br />
...
<a href="https://myaccount.google.com/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM001211.png" width=100 height=100 alt="Abhishek Gupta, Pradhyot Sharma, Piyush Shukla and Prakhar Trivedi" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/donnieboiii" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Pradhyot Sharma and Piyush Shukla</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917844929462 and +919161741999</h4>
		<h4 style="font-family:'typo' ">panditofcodes@gmail.com</h4>
		<h4 style="font-family:'typo' ">Jagran College Of Arts, Science and Commerce</h4></div></div>
		</p>
      </div>
